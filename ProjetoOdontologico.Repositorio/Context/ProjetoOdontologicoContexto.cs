...
{
    #region Atributos1
    private string _stringConexao = "Server=WALTER-PC\\SQLEXPRESS;Database=SitemaGestaoOdontologica;TrustServerCertificate=true;Trusted_Connection=True;"; //Minha string de conexão com o banco de dados
